...
const AboutSection = () => {
  ...
  <div className="container mx-auto flex flex-col md:flex-row items-center justify-center md:gap-10">
    ...
    <div style={{backgroundImage: "url('https://res.cloudinary.com/dx0dgujbj/image/upload/v1707888470/CerviCare/Homepage/4_mcgdyf.png')", backgroundSize: "cover", backgroundPosition: "center"}}
             className="md:w-[657px] w-full sm:h-[510px] h-[222px] rounded-[20px] shrink-0"> 
